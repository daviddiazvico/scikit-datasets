...
In the `project page <https://github.com/daviddiazvico/scikit-datasets>`_ hosted by
Github you can find more information related to the development of the package.

Installation
------------

Currently, scikit-datasets is available in Python 3, regardless of the
platform. The stable version can be installed via
`PyPI <https://pypi.org/project/scikit-datasets/>`_:
...
If you want to contribute routines for fetching data from a new repository,
please first open a new issue or draft PR to discuss it.

License
-------

The package is licensed under the MIT License. A copy of the
`license <https://github.com/daviddiazvico/scikit-datasets/blob/master/LICENSE.txt>`_
