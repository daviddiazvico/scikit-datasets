...
def load_glass_0_1_6_vs_2(return_X_y=False):
    """Load glass-0-1-6_vs_2 dataset.

    Loads the glass-0-1-6_vs_2 dataset.
    ...
    """
    return load_imbalanced('glass-0-1-6_vs_2',
