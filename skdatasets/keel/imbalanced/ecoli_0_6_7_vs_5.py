...
def load_ecoli_0_6_7_vs_5(return_X_y=False):
    """Load ecoli-0-6-7_vs_5 dataset.

    Loads the ecoli-0-6-7_vs_5 dataset.
    ...
    """
    return load_imbalanced('ecoli-0-6-7_vs_5',
