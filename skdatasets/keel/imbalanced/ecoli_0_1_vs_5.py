...
def load_ecoli_0_1_vs_5(return_X_y=False):
    """Load ecoli-0-1_vs_5 dataset.

    Loads the ecoli-0-1_vs_5 dataset.
    ...
    """
    return load_imbalanced('ecoli-0-1_vs_5',
